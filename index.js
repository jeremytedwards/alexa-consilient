...
var localeResponseEN = [
    'Welcome to Consilient Search. What are you searching for?',
    'Consilient Search Result for: ',
    'Error',
...
var localeResponseDE = [
    'Willkommen zur Consilient Suche. Wonach soll ich suchen?',
    'Consilient Suche nach: ',
    'Fehler',
...
// Create Consilient search URL - this made up of the main search URL plus a language modifier (currently only needed for German)

var localeConsilientENGB = ["http://www.google.co.uk/search?q=","&hl=en-GB"];
var localeConsilientDE = ["http://www.google.com/search?q=","&hl=de"];
var localeConsilientENUS = ["http://www.google.com/search?q=",""];

var sessionLocale = '';

var localeResponse = localeResponseEN;
var localeConsilient = localeConsilientENUS;


var APP_ID = undefined; //replace with 'amzn1.echo-sdk-ams.app.[your-unique-value-here]';

var AlexaConsilientSearch = function() {
	AlexaSkill.call(this, APP_ID);
}

AlexaConsilientSearch.prototype = Object.create(AlexaSkill.prototype);
AlexaConsilientSearch.prototype.constructor = AlexaConsilientSearch;

AlexaConsilientSearch.prototype.eventHandlers.onLaunch = function(launchRequest, session, response) {
	console.log("AlexaConsilientSearch onLaunch requestId" + launchRequest.requestId + ", sessionId: " + session.sessionId);
	var speechOutput = localeResponse[0];
	var repromptText = localeResponse[0];
	response.ask(speechOutput, repromptText);
}

AlexaConsilientSearch.prototype.intentHandlers = {
    ...
    function parsePage (url,backUpText) {
		...
		var queryString = localeConsilient[0] + query + '&oe=utf8' + localeConsilient[1];
...
exports.handler = function(event, context) {
	var AlexaConsilientSearchHelper = new AlexaConsilientSearch();
